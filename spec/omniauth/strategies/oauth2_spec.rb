...
describe OmniAuth::Strategies::Airtable do
  ...
  let(:fresh_strategy) { Class.new(OmniAuth::Strategies::Airtable) }
  ...
  describe "Subclassing Behavior" do
    ...
    it "performs the OmniAuth::Strategy included hook" do
      expect(OmniAuth.strategies).to include(OmniAuth::Strategies::Airtable)
...
describe OmniAuth::Strategies::Airtable::CallbackError do
  let(:error) { Class.new(OmniAuth::Strategies::Airtable::CallbackError) }
  describe "#message" do
    subject { error }
